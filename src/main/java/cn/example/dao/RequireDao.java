...
//    @Insert("insert into supply values(#{id},#{supplyname},#{supplylongitude},#{supplylatitude},#{supplycapacity})")
    @Insert("insert into requirepoint values(#{id},#{requirename},#{requirelongitude},#{requirelatitude},#{requirecapacity})")
     ...
     * @param require
     */
    @Update("update requirepoint set requirename=#{requirename},requirelongitude=#{requirelongitude},requirelatitude=#{requirelatitude},requirecapacity=#{requirecapacity} where id=#{id}")
