...
public interface VehicleDao {
     ...
     * 添加车辆信息
     */
    @Insert("insert into vehicle values(#{id},#{carname},#{carcapacity},#{carnumber},#{carload},#{carlength},#{drivername},#{driverphone})")
     ...
     * @param vehicle
     */
    @Update("update vehicle set carname=#{carname},carcapacity=#{carcapacity},carnumber=#{carnumber},carload=#{carload},carlength=#{carlength},drivername=#{drivername},driverphone=#{driverphone} where id=#{id}")
